...
UI_SOURCE = (
    ...
    + (STATIC_UI_DIR / "studio-admin.js").read_text(encoding="utf-8")
    + (STATIC_UI_DIR / "studio-bootstrap.js").read_text(encoding="utf-8")
    ...
    def test_server_can_start_without_opening_a_browser(self):
        ...
        try:
            ...
            for asset, content_type in (
                ...
                ("ui/studio-admin.js", "text/javascript"),
                ("ui/studio-bootstrap.js", "text/javascript"),
