...
`#` 프롬프트 주석 · 프롬프트 메모장 · 스트리밍 미리보기 · 자동 업데이트 · Electron/Tauri 껍데기 ·
다국어. 이유는 `개발계획.md` 에 적어 두었다.
...
| `후보사전.json` | 위 태그 목록에서 파생. [단부루 태그 그룹](https://danbooru.donmai.us/wiki_pages/tag_groups) 분류를 기준으로 짰다 |
