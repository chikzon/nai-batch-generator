...
from src.nai_studio.web import application_server as _application_server
...
class ConfigServer(_application_server.ConfigServer):
    """레거시 진입·시험이 쓰는 호환 서브클래스 — namespace만 고정한다."""
