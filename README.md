...
| 파일 | 누구에게 알맞은가 |
| --- | --- |
| `NAI배치생성기-1.0.0-setup.exe` | 일반 사용자 권장. 설치·제거가 가능한 Windows x64 설치본 |
| `NAI배치생성기-Windows-x64-portable.zip` | 설치하지 않고 원하는 폴더에서 쓰려는 사용자 |
| `NAI배치생성기-기본자료팩.zip` | 빌더 후보와 태그 검색·자동완성을 함께 쓰려는 사용자 |
